...
export function buildCanvasControlInstructions(shimPath: string): string {
  ...
  return [
    ...
    '- `open-claude [--count N] [--cwd P] [--prompt T] [--group <id>] [--after <id,id>] [--title T] [--project <id>]` — open N Claude sessions.',
    `- \`open-agent --agent ${agentChoices} [--count N] [--cwd P] [--prompt T] [--group <id>] [--after <id,id>] [--title T] [--project <id>]\` — open`,
...
- \`open-claude [--count N] [--cwd P] [--prompt T] [--group <id>] [--after <id,id>] [--title T] [--project <id>]\` — open N Claude sessions (default 1).
- \`open-agent --agent ${agentChoices} [--count N] [--cwd P] [--prompt T] [--group <id>] [--after <id,id>] [--title T] [--project <id>]\` — open N sessions of any agent CLI.
