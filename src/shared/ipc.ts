...
export const IPC = {
  ...
  swarmCreate: 'swarm:create',
  swarmGet: 'swarm:get',
  swarmList: 'swarm:list',
  swarmSetGoal: 'swarm:set-goal',
  swarmSetWorkspace: 'swarm:set-workspace',
  swarmActivate: 'swarm:activate',
  swarmBind: 'swarm:bind',
  swarmTick: 'swarm:tick',
  swarmApprove: 'swarm:approve',
  swarmPause: 'swarm:pause',
  swarmResume: 'swarm:resume',
  swarmCancel: 'swarm:cancel',
  swarmEnsureTui: 'swarm:ensure-tui',
  swarmCaps: 'swarm:caps',
  swarmNoteIdle: 'swarm:note-idle',
  /** Host → renderer: a mission mutated (TUI /activate, tick, approve…). */
  swarmChanged: 'swarm:changed',
