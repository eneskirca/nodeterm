  ...
  return (
    ...
    >
      ...
      <div className="group-node__label">
        ...
        {wt && (
          <div className="group-node__wt nodrag">
            ...
            {!stale && hasDepParent && (
              <Tooltip label="Sync: rebase this branch onto its dependency parent">
                <button
                  className="group-node__wt-btn"
                  aria-label="Sync: rebase onto parent"
      ...
      <div className="group-node__actions nodrag">
        <Tooltip label="Open as canvas (drill into this group)">
          <button
            className="group-node__drill"
            aria-label="Open as canvas (drill into this group)"
        ...
        <Tooltip label="Remove group (keeps nodes)">
          <button
            className="group-node__close"
            aria-label="Remove group (keeps nodes)"
            onClick={ungroup}
          >
            <IconClose />
          </button>
