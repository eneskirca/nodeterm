...
export function CardModal({ session, columnTitle, board, onChangeBoard, onClose, onOpenCanvas, onRename, onEditSticky, onBrowserNav, onSetIcon, githubRepository, onChangeNodeLinks, onAttachLink }: CardModalProps) {
